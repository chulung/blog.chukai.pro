...
import com.wenchukai.blog.model.UserExample.Criteria;
import com.wenchukai.blog.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getAuthority() != null) {
            VALUES("authority", "#{authority,jdbcType=INTEGER}");
        }
        ...
        if (record.getRememberLogin() != null) {
            VALUES("remember_Login", "#{rememberLogin,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getRememberLogin() != null) {
            SET("remember_Login = #{record.rememberLogin,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getRememberLogin() != null) {
            SET("remember_Login = #{rememberLogin,jdbcType=INTEGER}");
        }
