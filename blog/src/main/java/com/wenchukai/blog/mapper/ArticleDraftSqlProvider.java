...
import com.wenchukai.blog.model.ArticleDraftExample.Criteria;
import com.wenchukai.blog.model.ArticleDraftExample.Criterion;
import com.wenchukai.blog.model.ArticleDraftExample;
import com.wenchukai.blog.model.ArticleDraftWithBLOBs;
import java.util.List;
import java.util.Map;

public class ArticleDraftSqlProvider {

    public String countByExample(ArticleDraftExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("article_draft");
    ...
    public String insertSelective(ArticleDraftWithBLOBs record) {
        BEGIN();
        INSERT_INTO("article_draft");
    ...
    public String selectByExampleWithBLOBs(ArticleDraftExample example) {
        BEGIN();
    ...
    public String selectByExample(ArticleDraftExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("id");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ArticleDraftWithBLOBs record = (ArticleDraftWithBLOBs) parameter.get("record");
        ArticleDraftExample example = (ArticleDraftExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ArticleDraftWithBLOBs record) {
        BEGIN();
        UPDATE("article_draft");
        ...
        if (record.getIsPublish() != null) {
            SET("is_publish = #{isPublish,jdbcType=INTEGER}");
        }
        ...
        if (record.getHtmlContext() != null) {
            SET("html_context = #{htmlContext,jdbcType=LONGVARCHAR}");
        }
    ...
    protected void applyWhere(ArticleDraftExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
