...
<@indexPage mianJs=["/backend/vendors/datatables/js/jquery.dataTables.min.js","/backend/vendors/datatables/dataTables.bootstrap.js","/backend/js/articlesDrafts.js"] miancss=[]>
		  <div class="col-md-10">
