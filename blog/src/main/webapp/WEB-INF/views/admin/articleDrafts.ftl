...
<@indexPage mianJs=["/admin/vendors/datatables/js/jquery.dataTables.min.js","/admin/vendors/datatables/dataTables.bootstrap.js","/admin/js/articlesDrafts.js"] miancss=[]>
		  <div class="col-md-10">
