    ...
    <article class="post format-standard hentry " v-if="article.id">
      <header class="entry-header">
        ...
        <div class="entry-meta">
          ...
          <span class="">分享至:<a
            :href="'http://service.weibo.com/share/share.php?url=https://chukai.pro/article/'+article.uri+'&appkey=2897075133&title=【'+article.title+'】'+article.summary+'&pic='+article.pic"
            target="_blank">
      ...
      <div>
        <p>原文链接:<a :href="'https://chukai.pro/article/'+article.uri">https://chukai.pro/article/{{article.uri}}</a>
        </p>
     ...
     <footer class="entry-footer">
        <span class="cat-links">发表在 <a href="https://blog.chukai.pro">初开的博客</a></span>
