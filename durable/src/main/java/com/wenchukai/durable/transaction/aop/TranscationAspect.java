package com.wenchukai.durable.transaction.aop;
...
import com.wenchukai.durable.transaction.annotation.Transaction;
...
public class TranscationAspect {
	...
	@Pointcut("execution(@com.wenchukai.durable.transaction.annotation.Transaction * *(..))")
