...
import com.wck.cache.annotation.ClearCacheAfter;
...
public class CacheAspect extends BaseComponent {
	...
	@Pointcut("execution(@com.wck.cache.annotation.Cache * *(..))")
	public void cachePointCut() {
	}

	@Pointcut("execution(@com.wck.cache.annotation.ClearCacheAfter * *(..))")
