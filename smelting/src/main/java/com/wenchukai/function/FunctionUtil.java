package com.wenchukai.function;
...
public class FunctionUtil {
	...
	private static final FunctionUtil instance = new FunctionUtil();

	private FunctionUtil() {
	}

	public static FunctionUtil getIntance() {
		return instance;
	}
	 ...
	 * @return
	 */
	public  <T> Map<Integer, Integer> groupingAndSum(List<T> list,
