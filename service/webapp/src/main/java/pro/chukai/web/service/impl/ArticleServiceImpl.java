...
import pro.chukai.web.mapper.ArticleDraftHistoryMapper;
import pro.chukai.web.mapper.ArticleDraftMapper;
import pro.chukai.web.mapper.ArticleMapper;
import pro.chukai.web.mapper.ArticleTagMapper;
import pro.chukai.web.model.*;
import pro.chukai.web.service.*;
...
public class ArticleServiceImpl extends BaseService implements ArticleService {
    ...
    private  Pattern domianPattern = Pattern.compile("(https:)?//(\\w+\\.)?chukai.pro.+?(\\.\\w{3})");
    @Override
