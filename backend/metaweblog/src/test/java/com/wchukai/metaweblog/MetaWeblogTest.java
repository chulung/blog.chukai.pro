package com.wchukai.metaweblog;
...
import com.wchukai.metaweblog.util.ReflectUtil;
import com.wchukai.metaweblog.xmlrpc.XmlRpcExecute;
...
/**
 * Created by wchukai on 2017/5/22.
 */
public class MetaWeblogTest extends BaseTest {
    ...
    public void setUp() {
        ...
        configInfo.setServerUrl("https://wchukai.com");
        configInfo.setUserName("wchukai");
        configInfo.setPassword("123456");
        configInfo.setSiteName("wchukai's craft");
